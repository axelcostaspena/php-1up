...
public class PhpNowdocToHeredocIntentionTest extends LightCodeInsightFixtureTestCase {
    ...
    private static File getProjectRootPath() {
        String testPath = PathManager.getJarPathForClass(PhpNowdocToHeredocIntention.class);
