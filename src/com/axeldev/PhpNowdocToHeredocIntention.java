...
public class PhpNowdocToHeredocIntention extends PsiElementBaseIntentionAction {
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement psiElement) {
        ...
        return stringLiteralExpression != null && PhpStringUtil.isPhpNowdoc(stringLiteralExpression);
    }
    ...
    private StringLiteralExpression convertPhpNowdocToHeredoc(StringLiteralExpression stringLiteralExpression) {
        String rawStringContent = PhpStringUtil.getPhpNowdocContent(stringLiteralExpression);
        ...
        return PhpStringUtil.createPhpHeredocPsiFromEscapedContent(stringLiteralExpression.getProject(), escapedStringContent, heredocIdentifier);
    }
